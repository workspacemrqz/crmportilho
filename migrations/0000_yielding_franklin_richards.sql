...
CREATE TYPE "public"."step_type" AS ENUM('ai', 'fixed');--> statement-breakpoint
...
CREATE TABLE "flow_steps" (
	...
	"buffer" integer DEFAULT 30 NOT NULL,
	"step_type" "step_type" DEFAULT 'ai' NOT NULL,
	"change_status_to" "lead_status",
	"change_priority_to" "priority",
...
--> statement-breakpoint
CREATE TABLE "followup_sent" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"conversation_id" varchar NOT NULL,
	"followup_message_id" varchar NOT NULL,
	"sent_at" timestamp DEFAULT now() NOT NULL,
	"lead_last_message_at" timestamp NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "followup_sent" ADD CONSTRAINT "followup_sent_conversation_id_conversations_id_fk" FOREIGN KEY ("conversation_id") REFERENCES "public"."conversations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "followup_sent" ADD CONSTRAINT "followup_sent_followup_message_id_followup_messages_id_fk" FOREIGN KEY ("followup_message_id") REFERENCES "public"."followup_messages"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "followup_messages_is_active_idx" ON "followup_messages" USING btree ("is_active");--> statement-breakpoint
CREATE INDEX "followup_sent_conversation_idx" ON "followup_sent" USING btree ("conversation_id");--> statement-breakpoint
CREATE INDEX "followup_sent_followup_idx" ON "followup_sent" USING btree ("followup_message_id");--> statement-breakpoint
CREATE UNIQUE INDEX "followup_sent_unique_idx" ON "followup_sent" USING btree ("conversation_id","followup_message_id");--> statement-breakpoint
CREATE INDEX "instances_name_idx" ON "instances" USING btree ("name");--> statement-breakpoint
